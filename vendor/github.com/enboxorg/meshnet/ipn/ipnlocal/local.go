...
import (
	...
	"github.com/enboxorg/meshnet/appc"
	"github.com/enboxorg/meshnet/client/tailscale/apitype"
	"github.com/enboxorg/meshnet/control/controlclient"
	"github.com/enboxorg/meshnet/control/controlknobs"
	"github.com/enboxorg/meshnet/drive"
	"github.com/enboxorg/meshnet/envknob"
	"github.com/enboxorg/meshnet/envknob/featureknob"
	"github.com/enboxorg/meshnet/feature"
	"github.com/enboxorg/meshnet/feature/buildfeatures"
	"github.com/enboxorg/meshnet/health"
	"github.com/enboxorg/meshnet/health/healthmsg"
	"github.com/enboxorg/meshnet/hostinfo"
	"github.com/enboxorg/meshnet/ipn"
	"github.com/enboxorg/meshnet/ipn/conffile"
	"github.com/enboxorg/meshnet/ipn/ipnauth"
	"github.com/enboxorg/meshnet/ipn/ipnext"
	"github.com/enboxorg/meshnet/ipn/ipnstate"
	"github.com/enboxorg/meshnet/log/sockstatlog"
	"github.com/enboxorg/meshnet/logpolicy"
	"github.com/enboxorg/meshnet/net/dns"
	"github.com/enboxorg/meshnet/net/dnscache"
	"github.com/enboxorg/meshnet/net/dnsfallback"
	"github.com/enboxorg/meshnet/net/ipset"
	"github.com/enboxorg/meshnet/net/netcheck"
	"github.com/enboxorg/meshnet/net/netkernelconf"
	"github.com/enboxorg/meshnet/net/netmon"
	"github.com/enboxorg/meshnet/net/netns"
	"github.com/enboxorg/meshnet/net/netutil"
	"github.com/enboxorg/meshnet/net/packet"
	"github.com/enboxorg/meshnet/net/tsaddr"
	"github.com/enboxorg/meshnet/net/tsdial"
	"github.com/enboxorg/meshnet/paths"
	"github.com/enboxorg/meshnet/syncs"
	"github.com/enboxorg/meshnet/tailcfg"
	"github.com/enboxorg/meshnet/tsd"
	"github.com/enboxorg/meshnet/tstime"
	"github.com/enboxorg/meshnet/types/appctype"
	"github.com/enboxorg/meshnet/types/dnstype"
	"github.com/enboxorg/meshnet/types/empty"
	...
	"github.com/enboxorg/meshnet/types/opt"
	"github.com/enboxorg/meshnet/types/persist"
	"github.com/enboxorg/meshnet/types/preftype"
	"github.com/enboxorg/meshnet/types/ptr"
	"github.com/enboxorg/meshnet/types/views"
	"github.com/enboxorg/meshnet/util/checkchange"
	"github.com/enboxorg/meshnet/util/clientmetric"
	"github.com/enboxorg/meshnet/util/dnsname"
	"github.com/enboxorg/meshnet/util/eventbus"
	"github.com/enboxorg/meshnet/util/execqueue"
	"github.com/enboxorg/meshnet/util/goroutines"
	"github.com/enboxorg/meshnet/util/mak"
	"github.com/enboxorg/meshnet/util/osuser"
	"github.com/enboxorg/meshnet/util/rands"
	"github.com/enboxorg/meshnet/util/set"
	"github.com/enboxorg/meshnet/util/slicesx"
	"github.com/enboxorg/meshnet/util/syspolicy/pkey"
	"github.com/enboxorg/meshnet/util/syspolicy/policyclient"
	"github.com/enboxorg/meshnet/util/syspolicy/ptype"
	"github.com/enboxorg/meshnet/util/testenv"
	"github.com/enboxorg/meshnet/util/usermetric"
	"github.com/enboxorg/meshnet/version"
	...
	"github.com/enboxorg/meshnet/wgengine/magicsock"
	"github.com/enboxorg/meshnet/wgengine/router"
	"github.com/enboxorg/meshnet/wgengine/wgcfg"
	"github.com/enboxorg/meshnet/wgengine/wgcfg/nmcfg"
)
...
func (b *LocalBackend) startLocked(opts ipn.Options) error {
	...
	if !loggedOut && (b.hasNodeKeyLocked() || wantRunning) {
...
func (b *LocalBackend) reconfigAppConnectorLocked(nm *netmap.NetworkMap, prefs ipn.PrefsView) {
	...
	const appConnectorCapName = "github.com/enboxorg/meshnet/app-connectors"
	defer func() {
		if b.hostinfo != nil {
